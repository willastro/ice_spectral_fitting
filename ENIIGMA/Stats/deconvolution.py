...
def deconv_all(filecomp):
    ...
    A_COO = 6e-17
    A_CO2 = 1.1e-16  # Peak at 4.26 ----> Taken from Bouilloud
    A_13CO2 = 7.8e-17#1.15e-16  # Peak at 4.26 ----> Taken from Bouilloud
    A_CO = 1.1e-17  # Peak at 4.67 ----> Taken from Gerakines1995
    A_SO2 = 3.4e-17  # Peak at 4.67 ----> Taken from Boogert1997
    ###########################
    ...
    try:
        ...
        for j in range(1, len(spn) - 1):
            ...
            if spn[j] == 'HCOOH':
            ...
            elif spn[j] == 'H2O_NH3_1_05_a':
                print('Decomposing H2O_NH3_1_0.5_a')
                ...
                df1.to_csv('Column_density_' +
                           'H2O_NH3_1_0.5_a' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_NH3_1_0.5_a.dat',
                           np.transpose([ntt, peak10b, peak20b, peak30b, peak40b, peak50b, peak60b, tot, y]))
                ...
                N_CO = N1
                N_CH3OH = N2
                Data1 = {'CO_in_mix': N_CO, 'CH3OH_in_mix': N_CH3OH}
                df1 = DataFrame(Data1, columns=['CO_in_mix', 'CH3OH_in_mix'], index=[0])
                df1.to_csv('Column_density_' +
            ...
            # """
                ...
                """
            elif spn[j] == 'CO_CH3OH_4_1_15K_bs':
                print('Decomposing CO_CH3OH_4_1_15K_bs')
                lam1, lam2 = 4.67, 9.67
                x1, x2 = find_nearest(ntt, lam1), find_nearest(ntt, lam2)
                ...
                N_CH3OH = N2
                N_CO = N1
                Data1 = {'CH3OH_in_mix': N_CH3OH, 'CO_in_mix': N_CO}
                df1 = DataFrame(Data1, columns=['CH3OH_in_mix', 'CO_in_mix'], index=[0])
                df1.to_csv('Column_density_' + 'CO_CH3OH_4_1_15K_bs' + '.csv', index=False)
                np.savetxt('Analytic_deconv_CO_CH3OH_4_1_15K_bs.dat', np.transpose([ntt, peak10b, peak20b, tot, y]))
            
            elif spn[j] == 'CO_CO2_15Kbs':
                print('Decomposing CO_CO2_15Kbs')
                lam1, lam2, lam3, lam4, lam5 = 4.24, 4.27, 4.28, 4.38, 4.67
                ...
                N_13CO2 = N4
                N_CO = N5
                Data1 = {'CO2_in_mix': N_CO2, '13CO2_in_mix': N_13CO2, 'CO_in_mix': N_CO}
                df1 = DataFrame(Data1, columns=['CO2_in_mix', '13CO2_in_mix', 'CO_in_mix'], index=[0])
                df1.to_csv('Column_density_' + 'CO_CO2_15Kbs' + '.csv', index=False)
                # plt.plot(ntt,y, ntt,peak10b,ntt,peak20b,ntt,peak30b,ntt,peak40b, ntt,tot)
                np.savetxt('Analytic_deconv_CO_CO2_15Kbs.dat', np.transpose([ntt, peak10b, peak20b, peak30b, peak40b, peak50b, tot, y]))
            
            elif spn[j] == 'COmie':
                print('Decomposing COmie')
                lam1, lam2, lam3 = 4.66, 4.67, 4.68
                ...
                Data1 = {'CO_pure': N_CO}
                df1 = DataFrame(Data1, columns=['CO_pure'], index=[0])
                df1.to_csv('Column_density_' + 'COmie' + '.csv', index=False)
                # plt.plot(ntt,y, ntt,peak10b,ntt,peak20b,ntt,peak30b,ntt,peak40b, ntt,tot)
                np.savetxt('Analytic_deconv_COmie.dat', np.transpose([ntt, peak10b, peak20b, peak30b, tot, y]))
            
            elif spn[j] == 'H2O_CH3OH_8p':
                print('Decomposing H2O_CH3OH_8p')
                lam1, lam2, lam3, lam4 = 2.88, 3.0, 9.66, 9.84
                x1, x2, x3, x4 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4)
                y1, y2, y3, y4 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)]
                guess = (y1, x1, 0.01, y2, x2, 0.01, y3, x3, 0.01, y4, x4, 0.01)
                popt, pcov = curve_fit(four_peaks_G, ntt, y, guess, maxfev=5000)
                pars10b = popt[0:3]
                pars20b = popt[3:6]
                pars30b = popt[6:9]
                pars40b = popt[9:12]
                ...
                Data1 = {'H2O_in_mix': N_H2O, 'CH3OH_in_mix': N_CH3OH}
                df1 = DataFrame(Data1, columns=['H2O_in_mix', 'CH3OH_in_mix'], index=[0])
                df1.to_csv('Column_density_' + 'H2O_CH3OH_8p' + '.csv', index=False)
                # plt.plot(ntt,y, ntt,peak10b,ntt,peak20b,ntt,peak30b,ntt,peak40b, ntt,tot)
                np.savetxt('Analytic_deconv_H2O_CH3OH_8p.dat', np.transpose([ntt, peak10b, peak20b, peak30b, peak40b, tot, y]))
            
            elif spn[j] == 'H2O_CH3OH_CO2_9_1_2_10K_Ehr':
                print('Decomposing H2O_CH3OH_CO2_9_1_2_10K_Ehr')
                lam1, lam2, lam3, lam4, lam5 = 2.88, 3.0, 4.27, 9.66, 9.84
                x1, x2, x3, x4,x5 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4), find_nearest(ntt, lam5)
                y1, y2, y3, y4, y5 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)], y[get_line_number2(x5, ntt)]
                guess = (y1, x1, 0.01, y2, x2, 0.01, y3, x3, 0.01, y4, x4, 0.01, y5, x5, 0.01)
                popt, pcov = curve_fit(five_peaks_G, ntt, y, guess, maxfev=5000)
                ...
                N_CO2 = N3
                N_CH3OH = N4+N5
                Data1 = {'H2O_in_mix': N_H2O, 'CO2_in_mix': N_CO2, 'CH3OH_in_mix': N_CH3OH}
                df1 = DataFrame(Data1, columns=['H2O_in_mix', 'CO2_in_mix', 'CH3OH_in_mix'], index=[0])
                df1.to_csv('Column_density_' + 'H2O_CH3OH_CO2_9_1_2_10K_Ehr' + '.csv', index=False)
                # plt.plot(ntt,y, ntt,peak10b,ntt,peak20b,ntt,peak30b,ntt,peak40b, ntt,tot)
                np.savetxt('Analytic_deconv_H2O_CH3OH_CO2_9_1_2_10K_Ehr.dat', np.transpose([ntt, peak10b, peak20b, peak30b, peak40b, peak50b, tot, y]))
            
            elif spn[j] == 'H2O_CO2_CH4_10_1_1_a':
                print('Decomposing H2O_CO2_CH4_10_1_1_a')
                lam1, lam2, lam3, lam4, lam5, lam6, lam7, lam8,lam9 = 2.88, 3.07, 3.47, 4.27, 4.39, 4.54, 6.0, 7.25, 7.68
                ...
                y1, y2, y3, y4, y5, y6, y7, y8, y9 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[
                    get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)], y[get_line_number2(x5, ntt)], y[
                    get_line_number2(x6, ntt)], y[get_line_number2(x7, ntt)], y[get_line_number2(x8, ntt)], y[get_line_number2(x9, ntt)]
                guess = (
                    y1, x1, 0.1, y2, x2, 0.1, y3, x3, 0.1, y4, x4, 0.1, y5, x5, 0.001, y6, x6, 0.01, y7, x7, 0.1, y8, x8,0.1, y9, x9,0.01)
                popt, pcov = curve_fit(nine_peaks_G, ntt, y, guess, maxfev=5000)
                pars10b = popt[0:3]
                pars20b = popt[3:6]
                pars30b = popt[6:9]
                ...
                N_13CO2 = N5
                N_CH4 = N9
                Data1 = {'H2O_in_mix': N_H2O, 'CO2_in_mix': N_CO2, '13CO2_in_mix': N_13CO2, 'CH4_in_mix': N_CH4}
                df1 = DataFrame(
                    Data1, columns=['H2O_in_mix', 'CO2_in_mix', '13CO2_in_mix', 'CH4_in_mix'], index=[0])
                df1.to_csv(
                    'Column_density_' + 'H2O_CO2_CH4_10_1_1_a' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_CO2_CH4_10_1_1_a.dat', np.transpose(
                    [ntt, peak10b, peak20b, peak30b, peak40b, peak50b, peak60b, peak70b, peak80b, peak90b, tot, y]))
            
            elif spn[j] == 'H2O_CH4_10_06_a_V3':
                print('Decomposing H2O_CH4_10_06_a_V3')
                lam1, lam2, lam3, lam4, lam5, lam6, lam7, lam8,lam9 = 2.88, 3.07, 3.47, 4.27, 4.39, 4.54, 6.0, 7.25, 7.68
                x1, x2, x3, x4, x5, x6, x7, x8, x9 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4), find_nearest(ntt, lam5), find_nearest(ntt, lam6), find_nearest(ntt, lam7), find_nearest(ntt, lam8), find_nearest(ntt, lam9)
                y1, y2, y3, y4, y5, y6, y7, y8, y9 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[
                    get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)], y[get_line_number2(x5, ntt)], y[
                ...
                df1 = DataFrame(
                    Data1, columns=['H2O_in_mix', 'CH4_in_mix'], index=[0])
                df1.to_csv(
                    'Column_density_' + 'H2O_CH4_10_06_a_V3' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_CH4_10_06_a_V3.dat', np.transpose(
                    [ntt, peak10b, peak20b, peak30b, peak40b, peak50b, peak60b, peak70b, peak80b, peak90b, tot, y]))
            
            elif spn[j] == 'H2O_NH3_Schutte':
                print('Decomposing H2O_NH3_Schutte')
                lam1, lam2, lam3, lam4 = 2.96, 3.04, 3.51, 8.97
                x1, x2, x3, x4 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4)
                y1, y2, y3, y4 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[
                    get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)]
                guess = (
                    y1, x1, 0.01, y2, x2, 0.1, y3, x3, 0.1, y4, x4, 0.1)
                popt, pcov = curve_fit(four_peaks_G, ntt, y, guess, maxfev=5000)
                pars10b = popt[0:3]
                pars20b = popt[3:6]
                pars30b = popt[6:9]
                ...
                N_H2O = N1+N2
                N_NH3 = N4
                Data1 = {'H2O_in_mix': N_H2O, 'NH3_in_mix': N_NH3}
                df1 = DataFrame(
                    Data1, columns=['H2O_in_mix', 'NH3_in_mix'], index=[0])
                df1.to_csv(
                    'Column_density_' + 'H2O_NH3_Schutte' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_NH3_Schutte.dat', np.transpose(
                    [ntt, peak10b, peak20b, peak30b, peak40b, tot, y]))
            
            elif spn[j] == 'H2O_CO_20_1_NASA':
                print('Decomposing H2O_CO_20_1_NASA')
                lam1, lam2, lam3, lam4, lam5 = 2.96, 3.04, 3.51, 4.53, 4.67
                x1, x2, x3, x4, x5 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4), find_nearest(ntt, lam5)
                y1, y2, y3, y4, y5 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[
                    get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)], y[get_line_number2(x5, ntt)]
                guess = (
                    y1, x1, 0.1, y2, x2, 0.1, y3, x3, 0.1, y4, x4, 0.1, y5, x5, 0.01)
                popt, pcov = curve_fit(five_peaks_G, ntt, y, guess, maxfev=5000)
                pars10b = popt[0:3]
                pars20b = popt[3:6]
                pars30b = popt[6:9]
                ...
                N_H2O = N1+N2+N3
                N_CO = N5
                Data1 = {'H2O_in_mix': N_H2O, 'CO_in_mix': N_CO}
                df1 = DataFrame(
                    Data1, columns=['H2O_in_mix', 'CO_in_mix'], index=[0])
                df1.to_csv(
                    'Column_density_' + 'H2O_CO_20_1_NASA' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_CO_20_1_NASA.dat', np.transpose(
                    [ntt, peak10b, peak20b, peak30b, peak40b, peak50b, tot, y]))
            
            elif spn[j] == 'H2O_CO2_10_1_Ehr':
                print('Decomposing H2O_CO2_10_1_Ehr')
                lam1, lam2, lam3, lam4, lam5 = 2.96, 3.04, 3.51, 4.27, 4.38
                x1, x2, x3, x4, x5 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3), find_nearest(ntt, lam4), find_nearest(ntt, lam5)
                y1, y2, y3, y4, y5 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[
                    get_line_number2(x3, ntt)], y[get_line_number2(x4, ntt)], y[get_line_number2(x5, ntt)]
                guess = (
                    y1, x1, 0.01, y2, x2, 0.1, y3, x3, 0.1, y4, x4, 0.01, y5, x5, 0.01)
                popt, pcov = curve_fit(five_peaks_G, ntt, y, guess, maxfev=5000)
                pars10b = popt[0:3]
                pars20b = popt[3:6]
                pars30b = popt[6:9]
                ...
                N_CO2 = N4
                N_13CO2 = N5
                Data1 = {'H2O_in_mix': N_H2O, 'CO2_in_mix': N_CO2, '13CO2_in_mix': N_13CO2}
                df1 = DataFrame(
                    Data1, columns=['H2O_in_mix', 'CO2_in_mix', '13CO2_in_mix'], index=[0])
                df1.to_csv(
                    'Column_density_' + 'H2O_CO2_10_1_Ehr' + '.csv', index=False)
                np.savetxt('Analytic_deconv_H2O_CO2_10_1_Ehr.dat', np.transpose(
                    [ntt, peak10b, peak20b, peak30b, peak40b, peak50b, tot, y]))
            
            elif spn[j] == 'SO2_lida':
                print('Decomposing SO2lida')
                lam1, lam2, lam3 = 7.46, 7.58, 7.66
                x1, x2, x3 = find_nearest(ntt, lam1), find_nearest(ntt, lam2), find_nearest(ntt,lam3)
                y1, y2, y3 = y[get_line_number2(x1, ntt)], y[get_line_number2(x2, ntt)], y[get_line_number2(x3, ntt)]
                guess = (y1, x1, 0.1, y2, x2, 0.1, y3, x3, 0.1)
                ...
                N3 = -P3 / A_SO2
                N_SO2 = (N1 + N2 + N3)
                Data1 = {'SO2_pure': N_SO2}
                df1 = DataFrame(Data1, columns=['SO2_pure'], index=[0])
                df1.to_csv('Column_density_' + 'SO2lida' + '.csv', index=False)
                # plt.plot(ntt,y, ntt,peak10b,ntt,peak20b,ntt,peak30b,ntt,peak40b, ntt,tot)
                np.savetxt('Analytic_deconv_SO2lida.dat', np.transpose([ntt, peak10b, peak20b, peak30b, tot, y]))
    except:
        pass
